...
public interface BookService {
	...
	List<BookView> getBookViewList(int page, String field, String query);
	
	// book 목록(view)를 요청할 때
	List<BookView> getBookViewList(int page, String field, String query, int codeCd);
	...
	// bookReview 목록(view)를 요청할 때
	List<BookReviewView> getBookReviewViewList(int no, int page, String field, String query);
