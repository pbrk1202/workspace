...
public class BookReviewView2 extends BookReview {
	...
	public BookReviewView2() {
		// TODO Auto-generated constructor stub
	}


	public BookReviewView2(int book_no, int book_review_no, int book_score, String book_review_content, 
			boolean book_review_pub, boolean book_review_del, int reg_no, Date reg_date, int mod_no, 
			Date mod_date, 
			String book_title, String book_pup_nm, String book_del_nm, String reg_nm, String mod_nm) {
	...
	public String toString() {
		return "BookReviewView2 [book_title=" + book_title + ", book_pup_nm=" + book_pup_nm + ", book_del_nm="
				+ book_del_nm + ", reg_nm=" + reg_nm + ", mod_nm=" + mod_nm + ", getBook_no()=" + getBook_no()
				+ ", getBook_review_no()=" + getBook_review_no() + ", getBook_score()=" + getBook_score()
				+ ", getBook_review_content()=" + getBook_review_content() + ", isBook_review_pub()="
				+ isBook_review_pub() + ", isBook_review_del()=" + isBook_review_del() + ", getReg_no()=" + getReg_no()
				+ ", getReg_date()=" + getReg_date() + ", getMod_no()=" + getMod_no() + ", getMod_date()="
