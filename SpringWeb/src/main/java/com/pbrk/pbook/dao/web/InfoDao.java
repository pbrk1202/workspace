...
public interface InfoDao {
	...
	// 내리뷰 목록 조회
	List<BookReviewView2> getBookReviewViewList(int offset, int size, int memberNo);
	...
	// 내한줄글 목록 조회
	List<SingleLineView> getInfoSingleLineViewList(int offset, int size, int memberNo);
