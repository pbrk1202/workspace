...
<html lang="en">
    ...
    <body class="text-center">
        <form method="post" action="login" class="form-signin">
            ...
            <input type="text" id="inputId" name="memberId" class="form-control" placeholder="아이디" required autofocus>
            <label for="inputPassword" class="sr-only">비밀번호</label>
            <input type="password" id="inputPassword" name="memberPwd" class="form-control" placeholder="비밀번호" required>
